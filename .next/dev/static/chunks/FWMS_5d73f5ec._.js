...
function TransportationPage() {
    ...
    const handleSchedulePickup = async ()=>{
        ...
        if (!formData.requesterId || !formData.wasteType || !formData.quantity) {
            __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please fill in Requester ID, Type, and Quantity");
            return;
        }
        if (!formData.requesterName) {
            __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please enter requester name");
            return;
        }
        ...
        if (isNaN(quantityNum) || quantityNum <= 0) {
            __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Quantity must be a positive number");
            return;
        }
        try {
            const storedUser = JSON.parse(localStorage.getItem("user") || "{}");
            ...
            if (!businessId) {
                __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Could not determine business. Please ensure you have waste entries logged.");
                return;
            }
...
_s(TransportationPage, "P4y2YPNNpTiejiiky1NlRxXefuA=");
...
//# sourceMappingURL=FWMS_5d73f5ec._.js.map