...
"[project]/FWMS/app/dashboard/farmer/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FarmerDashboardPage({ user }) {
    _s();
    const [availableWaste, setAvailableWaste] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FarmerDashboardPage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "FarmerDashboardPage.useEffect.interval": ()=>{
                    fetchAvailableWaste();
                    fetchMyRequests();
                }
            }["FarmerDashboardPage.useEffect.interval"], 5000);
            return ({
                "FarmerDashboardPage.useEffect": ()=>clearInterval(interval)
            })["FarmerDashboardPage.useEffect"];
        }
    }["FarmerDashboardPage.useEffect"], []);
    const handleRequestCollection = async (wasteId, itemName)=>{
        try {
            ...
            const data = await response.json();
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Collection Requested", {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.error || "Failed to request collection");
            }
        } catch (error) {
    ...
    const activeRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FarmerDashboardPage.useMemo[activeRequests]": ()=>{
            return myRequests.filter({
                "FarmerDashboardPage.useMemo[activeRequests]": (r)=>r.status !== "completed" && r.status !== "collected"
            }["FarmerDashboardPage.useMemo[activeRequests]"]);
        }
    }["FarmerDashboardPage.useMemo[activeRequests]"], [
        myRequests
    ...
    const completedRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FarmerDashboardPage.useMemo[completedRequests]": ()=>{
            return myRequests.filter({
                "FarmerDashboardPage.useMemo[completedRequests]": (r)=>r.status === "completed" || r.status === "collected"
            }["FarmerDashboardPage.useMemo[completedRequests]"]);
        }
    }["FarmerDashboardPage.useMemo[completedRequests]"], [
        myRequests
    ...
    const filteredHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FarmerDashboardPage.useMemo[filteredHistory]": ()=>{
            ...
            return completedRequests.filter({
                "FarmerDashboardPage.useMemo[filteredHistory]": (r)=>{
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsTrigger"], {
                                            ...
                                            children: [
                                                ...
                                                "Request Collection",
                                                availableWaste.filter((f)=>!requestedWasteIds.has(f.id)).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    isApproved && request.cafeContact && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                ...
                                                                                children: [
                                                                                    ...
                                                                                    request.cafeContact.name && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                        className: "flex items-center gap-2",
                                                                                        children: [
                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                className: "font-semibold text-foreground min-w-[100px]",
                                                                                    ...
                                                                                    request.cafeContact.email && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                        className: "flex items-center gap-2",
                                                                                        children: [
                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                className: "font-semibold text-foreground min-w-[100px]",
                                                                                    ...
                                                                                    request.cafeContact.phone && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                        className: "flex items-center gap-2",
                                                                                        children: [
                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                                                className: "font-semibold text-foreground min-w-[100px]",
                                                                                    ...
                                                                                    request.cafeContact.address && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(FarmerDashboardPage, "uuTpZjenCHgVmtx4bX78MR7xL08=");
_c = FarmerDashboardPage;
const __TURBOPACK__default__export__ = _c1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$components$2f$with$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withAuth"])(FarmerDashboardPage, [
    "farmer"
]);
var _c, _c1;
...
//# sourceMappingURL=FWMS_28efaa71._.js.map