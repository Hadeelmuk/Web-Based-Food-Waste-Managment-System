...
async function GET(req) {
    ...
    const items = __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$app$2f$api$2f$_data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wasteLogs"].filter((w)=>w.type === "edible" && w.status === "pending" && w.assignedTo === "charity" && !requestedWasteIds.has(w.id) // Don't show items that already have requests
    ).map((w)=>({
            id: w.id,
            cafeId: w.cafeId,
            itemName: w.itemName,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3d56ca58._.js.map