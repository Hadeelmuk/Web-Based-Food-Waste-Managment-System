...
"[project]/FWMS/app/api/collections/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const pickupRequestSchema = __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    businessId: __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
...
async function GET(request) {
    try {
        ...
        const [requests, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.findMany({
                where,
                include: {
                    requester: {
                        select: {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.count({
                where
            })
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        const business = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].business.findUnique({
            where: {
        ...
        if (validatedData.wasteEntryId) {
            ...
            if (wasteEntry.businessId !== validatedData.businessId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Waste entry does not belong to this business"
                }, {
                    status: 400
                });
            }
            // Check if already has a request
            const existingRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.findUnique({
                where: {
                    wasteEntryId: validatedData.wasteEntryId
                }
            });
            if (existingRequest) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "This waste entry already has a pickup request"
                }, {
                    status: 400
                });
            }
        ...
        if (isManualRequest) {
            ...
            const partnerUser = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findFirst({
                where: {
        ...
        const pickupRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5763355d._.js.map