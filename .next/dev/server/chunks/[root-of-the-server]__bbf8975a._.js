...
"[project]/FWMS/app/api/reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (reportType === "summary") {
            ...
            for (const entry of allEntries){
                if (!wasteByAction[entry.actionType]) {
                    wasteByAction[entry.actionType] = {
                        quantity: 0,
                        count: 0
                    };
                }
        ...
        if (reportType === "admin") {
            ...
            // Get all data
            const totalUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.count();
            const totalBusinesses = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].business.count();
            ...
            const allBusinesses = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].business.findMany();
            ...
            const wasteByBusiness = {};
            for (const entry of allWasteEntries){
                if (!wasteByBusiness[entry.businessId]) {
                    wasteByBusiness[entry.businessId] = {
                        quantity: 0,
                        count: 0
                    };
                }
            ...
            // Sort and get top 10
            const topBusinessesArray = Object.entries(wasteByBusiness).sort((a, b)=>b[1].quantity - a[1].quantity).slice(0, 10);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbf8975a._.js.map