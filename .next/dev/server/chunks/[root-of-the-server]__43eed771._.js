...
async function GET(req) {
    ...
    try {
        ...
        const pickupRequests1 = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.findMany({
            where,
            include: {
                requester: {
                    select: {
        ...
        const items = pickupRequests1.map((p)=>{
            const waste = p.wasteEntry;
            const requester = p.requester;
            const requesterType = requester.business?.type === "NGO" ? "charity" : "farmer";
            return {
                id: p.id,
        ...
        console.log(`[Admin Pickups] Returning ${items.length} pickup requests`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43eed771._.js.map