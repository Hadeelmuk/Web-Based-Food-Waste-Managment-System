...
async function GET(req) {
    ...
    const requestedWasteIds = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$app$2f$api$2f$_data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickupRequests"].filter((p)=>p.status === "pending" || p.status === "approved").map((p)=>p.wasteId));
    // Debug: Log all waste logs for troubleshooting
    console.log(`[Farmer Available] Total waste logs: ${__TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$app$2f$api$2f$_data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wasteLogs"].length}`);
    ...
    const organicCoffeeItems = __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$app$2f$api$2f$_data$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["wasteLogs"].filter((w)=>w.type === "organic" || w.type === "coffee");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b36b097b._.js.map