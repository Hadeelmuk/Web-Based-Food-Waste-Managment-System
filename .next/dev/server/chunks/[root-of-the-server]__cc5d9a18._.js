...
"[project]/FWMS/app/api/user/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request) {
    try {
        ...
        if (user.businessId && (businessName || businessPhone || businessAddress)) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].business.update({
                where: {
                    id: user.businessId
                },
                data: {
        ...
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                id: user.id
            },
            include: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc5d9a18._.js.map