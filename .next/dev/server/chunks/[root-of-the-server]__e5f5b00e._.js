...
"[project]/FWMS/app/api/staff/waste/[id]/drop/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    try {
        ...
        if (wasteEntry.businessId !== businessId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Forbidden: waste does not belong to your business"
            }, {
                status: 403
            });
        }
        // Cancel any pending or approved pickup requests for this waste item
        await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].pickupRequest.updateMany({
            where: {
            ...
            data: {
                status: "CANCELLED",
                notes: body.notes ? `${body.notes} (Request cancelled: Item marked as dropped)` : "Request cancelled: Item marked as dropped by café"
            }
        });
        // Update waste entry status to DROPPED
        const updatedWasteEntry = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].wasteEntry.update({
            where: {
                id: wasteId
            },
            data: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedWasteEntry);
    } catch (error) {
        console.error("[Drop Waste] Error:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to drop waste entry",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e5f5b00e._.js.map