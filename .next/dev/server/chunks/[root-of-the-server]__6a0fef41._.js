...
"[project]/FWMS/app/api/admin/transportations/[id]/complete/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        const transportation = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].transportation.findUnique({
            where: {
                id: transportId
            },
            include: {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].$transaction(async (tx)=>{
            ...
            if (transportation.pickupRequestId) {
                updatedPickupRequest = await tx.pickupRequest.update({
                    where: {
                        id: transportation.pickupRequestId
                    },
                    data: {
                        status: "COMPLETED",
                        completedAt: now
            ...
            if (wasteEntryId && points > 0) {
                ...
                if (!existingPoints) {
                    const requesterName = transportation.pickupRequest?.requester?.business?.name || transportation.pickupRequest?.requester?.name || transportation.destination || "Unknown";
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$FWMS$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to complete transportation",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a0fef41._.js.map