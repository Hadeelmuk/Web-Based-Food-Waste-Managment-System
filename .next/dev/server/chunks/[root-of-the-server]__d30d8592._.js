...
"[project]/FWMS/app/api/staff/drop-alerts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const alerts = entries.map((entry)=>{
            ...
            const daysLeft = expiryDate ? Math.ceil((expiryDate.getTime() - today.getTime()) / (1000 * 60 * 60 * 24)) : 0;
            return {
                id: entry.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d30d8592._.js.map