...
// POST /api/farmer/requests/[id]/collected
// Farmer marks their pickup request as collected (they picked it up themselves).
// When collected:
...
export async function POST(
  ...
  try {
    // Verify user is a farmer (PARTNER with FARM business)
    ...
    // Ensure this pickup belongs to the authenticated farmer
    ...
    console.error("[Farmer Collected] Error:", error)
    return NextResponse.json(
