...
export default function FarmerPortalPage() {
  ...
  const fetchAvailableWaste = async () => {
    try {
      ...
      const userId = storedUser.userId || "u-farmer-1"
  ...
  const handleRequestCollection = async (wasteId: string, itemName: string) => {
    try {
      const storedUser = JSON.parse(localStorage.getItem("user") || "{}")
      const farmerId = storedUser.userId || "u-farmer-1"
                        ...
                        <div className="flex items-start justify-between gap-6">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                <h3 className="font-display font-bold text-xl text-foreground">{request.itemName || waste?.itemName || "Unknown Item"}</h3>
                            ...
                            <div className="flex items-center gap-4 text-sm">
                              <div className="flex items-center gap-2 text-muted-foreground">
                                ...
                                <span>Quantity: <span className="font-medium text-foreground">{request.quantity || 0} kg</span></span>
                              </div>
                            </div>
                          </div>
                      ...
                      <Card key={request.id} className="p-6 border-2 border-blue-500 bg-blue-50/50 hover:shadow-lg transition-shadow">
                        <div className="flex items-start justify-between gap-6">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-2 mb-4">
                              <span className="text-sm text-muted-foreground">Quantity:</span>
                              <span className="font-bold text-lg text-foreground">{request.quantity || 0} kg</span>
                            </div>
                          </div>
